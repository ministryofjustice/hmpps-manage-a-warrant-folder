...
export interface paths {
  ...
  '/api/offenders/{offenderNo}/alerts/v2': {
    /** System or cat tool access only<p>This endpoint uses the REPLICA database.</p> */
  ...
  '/api/bookings/v2': {
    /** Returns data that is available to the users caseload privileges, at least one attribute of a prisonId, bookingId or offenderNo must be specified<p>This endpoint uses the REPLICA database.</p> */
